<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewTemplate.aspx.cs" Inherits="SelfAspNet.Chap04.GridViewTemplate" %>
            ...
            <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="aid" DataSourceID="sds" ForeColor="Black" GridLines="Vertical" PageSize="3" ShowFooter="True" OnRowUpdating="grid_RowUpdating" OnRowUpdated="grid_RowUpdated" OnRowCreated="grid_RowCreated">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="備考" SortExpression="comment">
                        <EditItemTemplate>
                            <asp:TextBox ID="txtComment" runat="server" Text='<%# Bind("comment") %>' Columns="60"></asp:TextBox>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="編集／削除" ShowHeader="False">
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnEdit" runat="server" CausesValidation="False" CommandName="Edit" Text="編集" />
                            &nbsp;<asp:Button ID="btnDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="削除" OnClientClick="return confirm('本当に削除しますか？')" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
