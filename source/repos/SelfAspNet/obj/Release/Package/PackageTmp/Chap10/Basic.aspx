<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Basic.aspx.cs" Inherits="SelfAspNet.Chap10.Basic" %>
...
<body>
    <form id="form1" runat="server">
        <div>
             <%-- ScriptManager：Scriptsプロパティが見当たらない... --%>
            <asp:ScriptManager ID="manager" runat="server" EnableCdn="True" AjaxFrameworkMode="Disabled" ScriptMode="Auto" ViewStateMode="Inherit">
                <Scripts>
            ...
            <script>
                <%-- id属性が"menu"である要素の配下から、class属性が"other"である画像だけを取り出してフェードアウトする --%>
                $(function () {
