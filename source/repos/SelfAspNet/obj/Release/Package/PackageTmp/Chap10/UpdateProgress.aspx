<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateProgress.aspx.cs" Inherits="SelfAspNet.Chap10.UpdateProgress" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <%-- ScriptManager：必ずページの先頭に1つだけ配置しておく必要がある。 --%>
            ...
            <%-- UpdateProgress --%>
            <asp:UpdateProgress ID="prog" runat="server" DisplayAfter="1000" DynamicLayout="False">
                 <%-- ProgressTemplateって何？？？ --%>
                <ProgressTemplate>
            ...
            <%-- time：一定時間ごとにTickイベントを発生 --%>
            <asp:Timer ID="tim" runat="server" Interval="10000"></asp:Timer>
        </div>
    </form>
</body>
</html>
