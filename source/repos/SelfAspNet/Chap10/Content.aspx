<%@ Page Title="" Language="C#" MasterPageFile="~/Chap10/MyApp.Master" AutoEventWireup="true" CodeBehind="Content.aspx.cs" Inherits="SelfAspNet.Chap10.Content" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="server">
    ...
    <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="aid" DataSourceID="sds" ForeColor="Black" GridLines="Vertical" PageSize="3">
        ...
        <Columns>
            <asp:HyperLinkField DataNavigateUrlFields="aid" DataNavigateUrlFormatString="https://wings.msn.to/album/{0}" DataTextField="aid" DataTextFormatString="{0}" HeaderText="アルバムコード" SortExpression="aid" />
            ...
            <asp:BoundField DataField="updated" HeaderText="最終更新日" SortExpression="updated" DataFormatString="{0:yyyy年MM月dd日(ddd)}" />
            <asp:CheckBoxField DataField="favorite" HeaderText="お気に入り" SortExpression="favorite" />
            <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" ButtonType="Button" HeaderText="編集／削除" />
        </Columns>
