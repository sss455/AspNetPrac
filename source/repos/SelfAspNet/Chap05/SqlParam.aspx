...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <%-- GridView--%>
            <asp:GridView ID="grid" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" DataKeyNames="aid" DataSourceID="sds" EmptyDataText="カテゴリは選択されていません。">
