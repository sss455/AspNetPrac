<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WizardTemplate.aspx.cs" Inherits="SelfAspNet.Chap09.WizardTemplate" %>
        ...
        <div>
            ...
            <asp:Wizard ID="wiz" runat="server" BackColor="#F7F6F3"
                ...
                <StartNavigationTemplate>
                    <asp:LinkButton ID="lnkNext" runat="server" CommandName="MoveNext">［書籍感想］へ</asp:LinkButton>
                </StartNavigationTemplate>
                <StepNavigationTemplate>
                    &nbsp;<asp:LinkButton ID="lnkPrev" runat="server" CommandName="MovePrevious" CausesValidation="False">[個人情報]へ</asp:LinkButton>|
                <asp:LinkButton ID="lnkNext" runat="server" CommandName="MoveNext">［自由欄］へ</asp:LinkButton>
                </StepNavigationTemplate>
                <FinishNavigationTemplate>
                    <asp:LinkButton ID="lnkComp" runat="server" CommandName="MoveComplete">入力を終了します。</asp:LinkButton>
                </FinishNavigationTemplate>
