<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridFriendly.aspx.cs" Inherits="SelfAspNet.Chap10.GridFriendly" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="アルバムコード">
                        <ItemTemplate>
                            <asp:HyperLink ID="link" runat="server"
                                NavigateUrl='<%#: FriendlyUrl.Href("~/album", Eval("aid"))%>'
                                Text='<%#: Eval("aid")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
