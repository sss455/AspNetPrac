    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator ID="reqName" runat="server" 
                ...
                ValidationGroup="MyValid" CssClass="valid"></asp:RequiredFieldValidator>
            <br />
            体重：<br />
            ...
            Kg<asp:RangeValidator ID="rngWeight" runat="server" 
                ...
                ValidationGroup="MyValid" CssClass="valid"></asp:RangeValidator>
            <br />
            誕生日：<br />
            ...
            <asp:CompareValidator ID="cmpBirth" runat="server" ControlToValidate="txtBirth" 
                ...
                SetFocusOnError="True" Type="Date" ValidationGroup="MyValid" 
            ...
            <asp:RegularExpressionValidator ID="regEmail" runat="server" 
                ...
                ValidationGroup="MyValid" CssClass="valid"></asp:RegularExpressionValidator>
            <br />
            E-Mail（確認）：<br />
            ...
            <asp:CompareValidator ID="cmpEmail2" runat="server" ControlToCompare="txtEmail" 
                ...
                SetFocusOnError="True" ValidationGroup="MyValid" CssClass="valid"></asp:CompareValidator>
            <br />
