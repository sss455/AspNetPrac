...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:FormView ID="fv" runat="server" AllowPaging="True" CellPadding="4" DataKeyNames="isbn" DataSourceID="sds" ForeColor="#333333" OnItemUpdated="FormView1_ItemUpdated" OnItemUpdating="fv_ItemUpdating">
                <EditItemTemplate>
                    ISBNコード：<br />
