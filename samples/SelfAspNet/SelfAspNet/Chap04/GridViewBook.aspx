<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridViewBook.aspx.cs" Inherits="SelfAspNet.Chap04.GridViewBook" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="published" DataFormatString="{0:yy/MM/dd}"
                        HeaderText="発売日" HtmlEncode="True" SortExpression="published" />
                    <asp:BoundField DataField="price" DataFormatString="{0:#,###円}" HeaderText="単価"
                        HtmlEncode="True" SortExpression="price" />
