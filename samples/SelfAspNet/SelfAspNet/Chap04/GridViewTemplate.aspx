    ...
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                DataSourceID="sds" ForeColor="Black" GridLines="Vertical" PageSize="3" OnRowCreated="grid_RowCreated" OnRowUpdated="grid_RowUpdated" OnRowUpdating="grid_RowUpdating" ShowFooter="True"
                ClientIDMode="Predictable" ClientIDRowSuffix="aid">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="分類" SortExpression="category">
                        <EditItemTemplate>
                            <asp:DropDownList ID="list" runat="server"
                                SelectedValue='<%# Bind("category") %>' DataSourceID="sds_list"
                    ...
                    <asp:TemplateField HeaderText="備考" SortExpression="comment">
                        <EditItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Columns="60"
                    ...
                    <asp:TemplateField HeaderText="最終更新日" SortExpression="updated">
                        <EditItemTemplate>
                            ...
                            <asp:CompareValidator ID="cmpUpdated" runat="server"
                                ControlToValidate="txtUpdated" ErrorMessage="最終更新日は日付形式で入力してください。"
                                Operator="DataTypeCheck" Type="Date" CssClass="valid">*</asp:CompareValidator>
                        </EditItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="編集／削除" ShowHeader="False">
                        ...
                        <ItemTemplate>
                            ...
                            &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False"
                                CommandName="Delete" OnClientClick="return confirm('本当に削除しますか？')" Text="削除" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
