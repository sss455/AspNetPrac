<%@ Page Title="電話番号を確認する" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="VerifyPhoneNumber.aspx.vb" Inherits="SelfAspNetVbIdentity.VerifyPhoneNumber" %>
