<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DataCache.aspx.vb" Inherits="SelfAspNetVb.DataCache" %>
...
<body>
    ...
    <div><asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" 
