<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MultiView.aspx.vb" Inherits="SelfAspNetVb.MultiView" %>
    ...
    <div>
        ...
        <asp:MultiView ID="mv" runat="server" ActiveViewIndex="0">
            <asp:View ID="v1" runat="server">
                <asp:GridView ID="grid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="aid" DataSourceID="sds" ForeColor="Black" GridLines="Vertical">
            ...
            <asp:View ID="v2" runat="server">
                <asp:FormView ID="fv" runat="server" AllowPaging="True" CellPadding="4" DataKeyNames="aid" DataSourceID="sdsDetail" ForeColor="#333333">
                    <EditItemTemplate>
                    ...
                    <InsertItemTemplate>
                        ...
                        <br />
                        分類:
                        <asp:TextBox ID="categoryTextBox0" runat="server" Text='<%# Bind("category") %>' />
                        <br />
                        備考:
                        <asp:TextBox ID="commentTextBox0" runat="server" Text='<%# Bind("comment") %>' />
                        <br />
                        最終更新日:
                        <asp:TextBox ID="updatedTextBox0" runat="server" Text='<%# Bind("updated") %>' />
                        <br />
                        お気に入り:
                        <asp:CheckBox ID="favoriteCheckBox0" runat="server" Checked='<%# Bind("favorite") %>' />
                        <br />
                    ...
                    <ItemTemplate>
                        <asp:Image ID="img" runat="server" ImageUrl='<%# Eval("aid", "~/Image/{0}.jpg") %>' />
                        <br />
                        アルバムコード:
                        ...
                        <br />
                        最終更新日:
                        <asp:Label ID="updatedLabel" runat="server" Text='<%# Eval("updated", "{0:yyyy/MM/dd}") %>' />
                        <br />
                        お気に入り:
                        <asp:CheckBox ID="favoriteCheckBox1" runat="server" Checked='<%# Bind("favorite") %>' Enabled="false" />
                        <br />
