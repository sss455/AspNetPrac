<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Db.aspx.vb" Inherits="SelfAspNetVb.Db" %>
...
<body>
    ...
    <div>
        <asp:TreeView ID="TreeView1" runat="server" DataSourceID="smds" ImageSet="News" 
