<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Chart2.aspx.vb" Inherits="SelfAspNetVb.Chart2" %>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:Chart ID="cht" runat="server" BackColor="PapayaWhip" BackGradientStyle="TopBottom" DataSourceID="sds" Height="250px" Width="500px">
                <Series>
                    <asp:Series Name="Series1" XValueMember="dating" YValueMembers="volume" YAxisType="Secondary">
                    </asp:Series>
