<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Timer.aspx.vb" Inherits="SelfAspNetVb.Timer" %>
...
<body>
    ...
    <div>
        ...
        <asp:Timer ID="tim" runat="server" Interval="10000">
        </asp:Timer>
    </div>
    </form>
</body>
