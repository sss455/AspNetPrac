<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SqlStored.aspx.vb" Inherits="SelfAspNetVb.SqlStored" %>
...
<body>
    ...
    <div>
        ...
        <asp:RadioButtonList ID="list" runat="server" AppendDataBoundItems="True" AutoPostBack="True" RepeatDirection="Horizontal" DataSourceID="sds_list" DataTextField="category" DataValueField="category">
        ...
        <asp:GridView ID="grid" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" EmptyDataText="カテゴリは選択されていません。" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" DataKeyNames="aid" DataSourceID="sds">
        ...
        <asp:SqlDataSource ID="sds" runat="server" ConnectionString="<%$ ConnectionStrings:SelfAsp %>" SelectCommand="AlbumFilter" SelectCommandType="StoredProcedure">
            <SelectParameters>
