<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ObjectParam.aspx.vb" Inherits="SelfAspNetVb.ObjectParam" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="grid" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="ods" EmptyDataText="カテゴリは選択されていません。" ForeColor="Black" GridLines="Vertical" AutoGenerateColumns="False" DataKeyNames="aid">
        ...
        <asp:ObjectDataSource ID="ods" runat="server" DeleteMethod="DeleteAlbumData" SelectMethod="GetAlbumData" TypeName="SelfAspNetVb.Album">
            <DeleteParameters>
