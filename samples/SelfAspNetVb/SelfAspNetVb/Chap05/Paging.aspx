<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Paging.aspx.vb" Inherits="SelfAspNetVb.Paging" %>
...
<body>
    ...
    <div>
        ...
        <asp:ObjectDataSource ID="ods" runat="server" 
            ...
            TypeName="SelfAspNetVb.AlbumDataSetTableAdapters.AlbumTableAdapter">
