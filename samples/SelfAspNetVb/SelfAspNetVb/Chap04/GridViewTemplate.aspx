<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GridViewTemplate.aspx.vb" Inherits="SelfAspNetVb.GridViewTemplate" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="grid" runat="server" AllowSorting="True" 
            ...
            DataSourceID="sds" ForeColor="Black" GridLines="Vertical" CssClass="Site.css" PageSize="3" AllowPaging="True" ShowFooter="True" >
                ...
                <asp:TemplateField HeaderText="分類" SortExpression="category">
                    <EditItemTemplate>
                        ...
                        <asp:SqlDataSource ID="sds_list" runat="server" 
                            ...
                            SelectCommand="SELECT DISTINCT [category] FROM [Album]"></asp:SqlDataSource>
                    </EditItemTemplate>
                    <ItemTemplate>
