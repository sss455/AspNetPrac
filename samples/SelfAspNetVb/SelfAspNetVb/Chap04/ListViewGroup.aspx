<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListViewGroup.aspx.vb" Inherits="SelfAspNetVb.ListViewGroup" %>
...
<body>
    ...
    <div>
        ...
        <asp:ListView ID="list" runat="server" DataKeyNames="isbn" DataSourceID="sds" GroupItemCount="3" InsertItemPosition="LastItem">
