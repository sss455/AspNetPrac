<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DetailsView.aspx.vb" Inherits="SelfAspNetVb.DetailsView" %>
    ...
    <div>
        <asp:DetailsView ID="dv" runat="server" AllowPaging="True" 
            ...
            <Fields>
                ...
                <asp:BoundField DataField="price" DataFormatString="{0:0,000円}" HeaderText="単価" 
