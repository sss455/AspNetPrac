<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FormView.aspx.vb" Inherits="SelfAspNetVb.FoemView" %>
    ...
    <div>
        ...
        <asp:FormView ID="fv" runat="server" AllowPaging="True" CellPadding="4" DataKeyNames="isbn" DataSourceID="sds" ForeColor="#333333">
            <EditItemTemplate>
                ...
                <br />
                CD-ROM：<asp:CheckBox ID="cdromCheckBox" runat="server" Checked='<%# Bind("cdrom") %>' />
                <br />
            ...
            <ItemTemplate>
                <asp:Image ID="img" runat="server" Height="160px" Width="110px" AlternateText='<%# Eval("title") %>' ImageUrl='<%# Eval("isbn", "http://www.wings.msn.to/books/{0}/{0}.jpg") %>' />
                <br />
                ISBNコード：<br /> 
                <asp:Label ID="isbnLabel" runat="server" Text='<%# Eval("isbn") %>' />
                <br />
                ...
                <br />
                CD-ROM：<asp:CheckBox ID="cdromCheckBox" runat="server" Checked='<%# Eval("cdrom") %>' Enabled="False" />
                <br />
