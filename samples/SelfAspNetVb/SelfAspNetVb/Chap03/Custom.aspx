<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Custom.aspx.vb" Inherits="SelfAspNetVb.Custom" %>
...
<body>
    ...
    <div>
        ...
        <asp:CustomValidator ID="cusName" runat="server"
            ...
            CssClass="valid" ErrorMessage="名前は20文字以内で入力してください。"></asp:CustomValidator>    
    </div>
    </form>
</body>
</html>
