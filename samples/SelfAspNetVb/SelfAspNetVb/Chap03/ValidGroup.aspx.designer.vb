...
Partial Public Class ValidGroup
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents rngWeight As Global.System.Web.UI.WebControls.RangeValidator
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents cmpBirth As Global.System.Web.UI.WebControls.CompareValidator
    ...
    '''変更するには、フィールドの宣言をデザイナー ファイルから分離コード ファイルに移動します。
    '''</remarks>
    Protected WithEvents cmpEmail2 As Global.System.Web.UI.WebControls.CompareValidator
