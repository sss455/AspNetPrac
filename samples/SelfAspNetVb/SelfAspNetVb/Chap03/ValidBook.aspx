<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ValidBook.aspx.vb" Inherits="SelfAspNetVb.ValidBook" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="txtIsbn" runat="server"></asp:TextBox><asp:RegularExpressionValidator
            ...
            ValidationExpression="[0-9]{3}-[0-9]{1}-[0-9]{3,5}-[0-9]{3,5}-[0-9X]{1}" 
